...
import { BookOpen, Check, Languages, Pencil, Plus, Trash2, X } from "lucide-react";
...
export function MenuTypeDialog({
  ...
  function setForm(patch: Partial<MenuTypeFormState>) {
  ...
  async function saveGeneral() {
    ...
    try {
      await menusService.update(menuTypeId, {
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <DialogTitle className="text-base font-semibold leading-tight">
                  {mode === "create" && t("menuType.titleCreate")}
                  {mode !== "create" && (generalEditing || translationsEditing ? t("menuType.titleEdit") : t("menuType.titleView"))}
                </DialogTitle>
                <DialogDescription className="text-xs mt-0.5">
                  {mode === "create" && t("menuType.descCreate")}
                  {mode !== "create" && (generalEditing || translationsEditing ? t("menuType.descEdit") : t("menuType.descView"))}
                </DialogDescription>
              </div>
            </div>
          </DialogHeader>
                          ...
                          <div key={idx} className="p-4 space-y-3">
                            ...
                            <div className="space-y-1.5">
                              ...
                              <Input value={row.name}
                                ...
                                placeholder={t("menuType.namePlaceholder")}
                                className="h-9 text-sm"
                              />
                            </div>
                            <div className="space-y-1.5">
                              ...
                              <Textarea value={row.description}
                                ...
                                placeholder={t("menuType.descriptionPlaceholder")}
                                rows={2}
