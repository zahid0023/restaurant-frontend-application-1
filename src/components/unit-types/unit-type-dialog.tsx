...
import type { UnitTypeDialogMode, UnitTypeFormState } from "./types";
import { UnitTypeGeneralInfo } from "./unit-type-general-info";
import { UnitTypeLocaleTranslations } from "./unit-type-locale-translations";
...
export function UnitTypeDialog({
  ...
  const headerTitle = mode === "create" ? t("unitType.titleCreate") : (isEditing ? t("unitType.titleEdit") : t("unitType.titleView"));
  const headerDesc = mode === "create" ? t("unitType.descCreate") : (isEditing ? t("unitType.descEdit") : t("unitType.descView"));
