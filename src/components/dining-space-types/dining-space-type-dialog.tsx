...
import { Check, Languages, LayersIcon, Pencil, Plus, Trash2, X } from "lucide-react";
...
export function DiningSpaceTypeDialog({
  ...
  async function saveGeneral() {
    ...
    try {
      await diningSpaceTypesService.update(typeId, { sort_order: Number(localSortOrder) || 0 });
      toast.success(t("diningSpaceType.updatedToast"));
      setGeneralEditing(false);
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <DialogTitle className="text-base font-semibold leading-tight">
                  ...
                  {mode !== "create" && (generalEditing || translationsEditing ? t("diningSpaceType.titleEdit") : t("diningSpaceType.titleView"))}
                </DialogTitle>
                <DialogDescription className="text-xs mt-0.5">
                  {mode === "create" && t("diningSpaceType.descCreate")}
                  {mode !== "create" && (generalEditing || translationsEditing ? t("diningSpaceType.descEdit") : t("diningSpaceType.descView"))}
                </DialogDescription>
              </div>
            </div>
          </DialogHeader>
              ...
              <div className="rounded-xl border bg-card p-4 space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  <div className="space-y-2 sm:col-span-2">
                    <Label htmlFor="dst-code" className="text-xs font-medium">{t("common.code")} *</Label>
                    <Input
                      id="dst-code"
                      value={form.code}
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="dst-sort" className="text-xs font-medium">{t("field.sort")} *</Label>
                    <Input
                      id="dst-sort"
                      type="number"
