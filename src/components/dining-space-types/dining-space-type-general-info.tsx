...
export interface DiningSpaceTypeGeneralInfoProps {
  mode: DiningSpaceTypeDialogMode;
  form: DiningSpaceTypeFormState;
  onFormChange: (patch: Partial<DiningSpaceTypeFormState>) => void;
  typeId?: number;
...
export function DiningSpaceTypeGeneralInfo({
  mode,
  form,
  onFormChange,
  typeId,
  ...
  onEditingChange,
  open,
}: DiningSpaceTypeGeneralInfoProps) {
