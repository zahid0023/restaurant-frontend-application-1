...
import { Check, FolderOpen, Languages, Pencil, Plus, Trash2, X } from "lucide-react";
...
export function MenuCategoryDialog({
  ...
  function setForm(patch: Partial<MenuCategoryFormState>) {
  ...
  async function saveGeneral() {
    ...
    try {
      await menuCategoriesService.update(categoryId, {
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <DialogTitle className="text-base font-semibold leading-tight">
                  {mode === "create" && t("menuCategory.titleCreate")}
                  {mode !== "create" && (generalEditing || translationsEditing ? t("menuCategory.titleEdit") : t("menuCategory.titleView"))}
                </DialogTitle>
                <DialogDescription className="text-xs mt-0.5">
                  {mode === "create" && t("menuCategory.descCreate")}
                  {mode !== "create" && (generalEditing || translationsEditing ? t("menuCategory.descEdit") : t("menuCategory.descView"))}
                </DialogDescription>
              </div>
            </div>
          </DialogHeader>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => {
                      ...
                      else setLocalGeneral({ sort_order: Number(e.target.value) });
                    }}
                          ...
                          <div key={idx} className="p-4 space-y-3">
                            ...
                            <div className="space-y-1.5">
                              ...
                              <Input value={row.name}
                                ...
                                placeholder={t("menuCategory.namePlaceholder")}
                                className="h-9 text-sm"
                              />
                            </div>
                            <div className="space-y-1.5">
                              ...
                              <Textarea value={row.description}
                                ...
                                placeholder={t("menuCategory.descriptionPlaceholder")}
                                rows={2}
